...
class Performance:
    ...
    def checked_calculate(self) -> "PerformanceAttributes":
        if hasattr(self.map_or_attrs, "check_suspicious"):
            try:
                self.map_or_attrs.check_suspicious()
...
class GradualPerformance:
    ...
    @classmethod
    def checked_new(cls, difficulty: Difficulty, map_data: Any) -> "GradualPerformance":
